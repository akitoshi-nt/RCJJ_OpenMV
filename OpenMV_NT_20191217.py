...
obj_color_yellow =   [(0, 100, -20, 20, 40, 127)]      # Yellow Goal
obj_color_blue   =   [(0, 100, -60, 15, -90, -20)]     # Blue Goal
...
sensor.set_auto_whitebal(False, rgb_gain_db = (-6, -6.02, -5) ) # must be turned off for color tracking
